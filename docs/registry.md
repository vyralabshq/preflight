...
| `PF-NET-0003` | NET | degraded | testnet mainnet | agave-validator | Pinned cores are clear of queue interrupts | PoH core against the queue interrupt map, preflight's own<br>docs.anza.xyz/operations/requirements, higher clock over more cores | 2026-09<br>2026-09 |

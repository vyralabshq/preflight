...
| `PF-HW-0008` | HW | degraded | testnet mainnet | agave-validator solana-test-validator firedancer unknown | CPU frequency governor is performance | docs.anza.xyz/operations/setup-a-validator, Set performance governor | 2026-09 |
...
| `PF-NET-0002` | NET | degraded | testnet mainnet | agave-validator solana-test-validator firedancer unknown | NIC queue interrupts are spread across cores | AMD EPYC Linux Network Tuning Guide, IRQ affinity<br>Intel Ethernet 800 Series perf tuning, IRQ affinity | 2026-09<br>2026-09 |
| `PF-NET-0003` | NET | degraded | testnet mainnet | agave-validator | Pinned cores are clear of queue interrupts | DEFAULT_PINNED_CPU_CORE in poh_service.rs, Some(0) on Linux<br>PoH core against the queue interrupt map, preflight's own<br>docs.anza.xyz/operations/requirements, higher clock over more cores | agave master<br>2026-09<br>2026-09 |
